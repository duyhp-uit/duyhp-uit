const Info = () => {
  return (
    <div className="flex items-center relative gap-x-2">
      ...
      <div
        className=" border-white border-solid border-[1px]
             rounded-[4px] w-[32px] h-[16px] flex justify-center items-center 
             after:absolute after:right-[-3px] after:w-[2px] after:h-[6px] after:ml-[1px] after:bg-white after:rounded-r-2xl
             "
      >
        <div className=" w-[30px] h-[12px] bg-white rounded-[3px]"></div>
      </div>
    </div>
  );
};
